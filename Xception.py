...
#############################################################
# DESCRIPTION: This program trains our model using Xception #
#              pre-trained model.                           #
#############################################################
...
model_checkpoint_cb = keras.callbacks.ModelCheckpoint(filepath=abspath_curr + 'Output/modelXception.h5',
                                                      save_best_only=True,
...
plt.grid(True)
plt.tight_layout()
plt.savefig(abspath_curr + 'Output/learning_curve_freezingXcep.pdf')
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(abspath_curr + 'Output/learning_curve_after_unfreezingXcep.pdf')
plt.show()
