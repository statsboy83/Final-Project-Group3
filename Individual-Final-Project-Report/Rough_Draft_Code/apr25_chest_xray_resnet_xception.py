# -*- coding: utf-8 -*-
"""Apr25_Chest_XRay_ResNet_Xception.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ar15tKgRDAPhT710SPR2CLTd0vTWBMms
...
# Make directory
directory = os.path.dirname(abspath_curr + '/result/model_1/')
...
model_checkpoint_cb = keras.callbacks.ModelCheckpoint(filepath=abspath_curr + '/result/model_1/model_1.h5',
                                                      save_best_only=True,
...
model.load_weights(filepath=abspath_curr + '/result/model_1/model_1.h5')
...
# Make directory
directory = os.path.dirname(abspath_curr + '/result/model_2/')
if not os.path.exists(directory):
    os.makedirs(directory)
...
# ModelCheckpoint callback
model_checkpoint_cb = keras.callbacks.ModelCheckpoint(filepath=abspath_curr + '/result/model_2/model_2.h5',
                                                      save_best_only=True,
...
# Load the saved model
model.load_weights(filepath=abspath_curr + '/result/model_2/model_2.h5')
